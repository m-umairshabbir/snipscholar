                ...
                child: Container(
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [AppColors.teal,AppColors.teal, AppColors.shinyTeal, Color(0xffd7e8fc),],
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Icon(Icons.swipe_right, color: AppColors.teal, size: 40), // Swipe Arrow Icon
                  ...
                  child: BlocBuilder<VisibilityBloc, VisibilityState>(
                    builder: (context, state) {
                      return Column(
                        ...
                        children: [
                          const Text('Login', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold,color: AppColors.teal)),
                          ...
                          const Row(
                            children: [
                              Text('Don\'t have an account?', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,color: AppColors.textDark)),
                              Text(' SignUp', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,color: AppColors.teal)),
                            ],
                          ),
                        ],
                      );
